...
public class AppPush {
    ...
    private static String appId = "ILixUaxs9AAy9sf6PMkJc1";
    private static String appKey = "crrNjw1Kbg5K9SMxmMSmI2";
    private static String masterSecret = "CvK3FPjbum6UHSChO3S513";
